    ...
    response = client.post(
        ...
        json={
            ...
            "state": [
                ...
                {"id": "boolean-gate-name", "property": "value", "value": "boolean"},
                {"id": "boolean-operation", "property": "value", "value": "AND"},
                {"id": "boolean-gate-a", "property": "value", "value": "g1"},
                {"id": "boolean-gate-b", "property": "value", "value": "g2"},
